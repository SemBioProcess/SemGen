...
function ParentNode(graph, id, name, parent, links, r, group, textSize, nodeType, charge) {
	Node.prototype.constructor.call(this, graph, id, name, parent, links, r, group, textSize, nodeType, charge);
