 ...
 */
public class SemGenRadialGraphViewFocusControl extends ControlAdapter {
     ...
     */
    public SemGenRadialGraphViewFocusControl() {
        this(1);
    }
     ...
     */
    public SemGenRadialGraphViewFocusControl(String focusGroup) {
        this(1);
        group = focusGroup;
    }
     ...
     */
    public SemGenRadialGraphViewFocusControl(int clicks) {
        ccount = clicks;
    }
     ...
     * @param clicks the number of clicks needed to switch the focus.
     */
    public SemGenRadialGraphViewFocusControl(String focusGroup, int clicks) {
        ccount = clicks;
        group = focusGroup;
    }
     ...
     */
    public SemGenRadialGraphViewFocusControl(int clicks, String act) {
        ccount = clicks;
        activity = act;
    }
     ...
     * @param act an action run to upon focus change 
     */
    public SemGenRadialGraphViewFocusControl(String focusGroup, int clicks, String act) {
        ccount = clicks;
        activity = act;
