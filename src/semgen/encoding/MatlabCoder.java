...
public class MatlabCoder extends Coder{
	...
	public void writefile() throws OWLException, IOException{
		SemGenProgressBar progframe = new SemGenProgressBar("Creating Matlab file", false, null);
		...
		orderedcdwduris = new ArrayList<String>(cdwduris);
