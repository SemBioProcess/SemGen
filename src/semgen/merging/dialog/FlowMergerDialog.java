...
public class FlowMergerDialog extends JDialog implements
	...
	public String disp;
	public OWLOntology discardedont, keptont;
	...
	public FlowMergerDialog(String disp, Set<String> flowdepsfromdiscarded,
		...
		setTitle("Possible altertions to "
				+ SemSimOWLFactory.getIRIfragment(disp)
				+ " equation identified");
		
		SemGenScrollPane scrollpane = new SemGenScrollPane(mainpanel);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o instanceof JButton && o != questionbutton) {
			...
			Object[] panestuff = new Object[] {
					new JLabel("Composite annotation: "),
					new JLabel("Singular annotation: "),
					new JLabel("Human readable definition: ") };
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		Hashtable<String,Set<String>> dispandsetofadds = new Hashtable<String, Set<String>>();
		...
		if (value == "OK") {
			...
			if (!choicesmade.contains(false)) {
				if (setofadds.size() > 0) {
					dispandsetofadds.put(disp, setofadds);
				}
				setVisible(false);
			} else {
