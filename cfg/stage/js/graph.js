...
function Graph() {
	...
	//Node type visibility: model, submodel, state, rate, constitutive, entity, process, mediator, null, extraction, unspecified, force, function
	this.nodesVisible = [true, true, true, true, true, true, true, true, true, true, true, true, true];
