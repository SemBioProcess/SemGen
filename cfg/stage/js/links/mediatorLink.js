...
MediatorLink.prototype.tickHandler = function (element, graph) {
	...
	root.select("path").attr("d", function(d) {
		...
		theta = Math.atan2(dy, dx) + Math.PI * 2,
				...
				arrowHeadWidth = 0; // Hide arrowhead for mediator links
...
MediatorLink.prototype.getKeyInfo = function () {
	return {
...
MediatorLink.prototype.createTextElement = function (className) {
